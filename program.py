        ...
        "GROUP BY": [
            {
                ...
                "task": "Show **department_id** and the **total number of employees** per department.",
            ...
            },
            {
                ...
                "task": "Show **department_id** and the **average salary** for each department.",
            ...
            },
            {
                ...
                "task": "List each **product** and the **total sales amount** for that product.",
            ...
            },
            {
                ...
                "task": "Show **department_id** and the **total salary budget** per department.",
            ...
            },
            {
                ...
                "task": "Show **employee_id** and the **total number of sales** per employee.",
            ...
            },
            {
                ...
                "task": "Show **employee_id** and their **average sale amount** (average deal size).",
            ...
            },
            {
                ...
                "task": "Show the **manager** name and the **number of departments** they manage.",
